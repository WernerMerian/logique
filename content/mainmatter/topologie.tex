...
\begin{definition}[Fonction continue]
  ...
  fonction $f : X \to Y$ est dite continue sur pour tout $U\in\Omega_Y$,
...
Le vraie théorème de dualité de Stone s'énonce sur les catégories, et ajoute le
...
On peut maintenant caractériser la compacité dans un espace métrique grâce à des
...
On peut donc définir la notion de séparabilité, qui est une propriété disant
