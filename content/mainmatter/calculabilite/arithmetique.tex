...
\begin{theorem}[Théorème d'incomplétude de Godel-Rosser]
...
\begin{definition}[Conditions de Hilbert-Bernays]
  Soit $\mathcal T$ une théorie munie d'une fonction $\square : \Prop \to \Prop$
  à une variable libre $x$. On dit que $(\mathcal T,\square)$ vérifie les
