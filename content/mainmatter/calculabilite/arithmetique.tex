...
\begin{theorem}[Extension conservative des fonctions RP]
  ...
  \cref{thm.chinois} et \cref{lem.beta}. Alors pour toute fonction RP $f$,
...
\begin{proof}
  ...
  On reprend les notations précédentes, et on montre que la formule représentant
  $\rec(f,g)$ est une relation fonctionnelle totale. Soient $(\vec x,n,y)$ des
  instances de la formule représentant $\rec(f,g)$. Remarquons que par
  construction, la suite qui sera construite comme trace du calcul sera de
  taille $n$
\end{proof}
