...
Cependant, là où les automates finis admettent de nombreuses formulations
équivalentes, ce n'est pas toujours le cas pour les automates à pile. En
particulier, les automates à pile sont par défaut non déterministes.
...
\begin{definition}[Automate à pile]
  Soit un alphabet $\Sigma$. Un automate à pile sur $\Sigma$ est la donnée
  d'un $5$-uplet $(Q,q_0,\Gamma,\alpha_0,R)$ où~:
  \begin{itemize}
...
\begin{proof}
  ...
  \item la relation $R$ est définie par les faits suivants~:
    ...
    \item pour toute règle $A_i \to w_i$, on ajoute les transitions (en considérant que
      $q_{i,0} = q_0$)
      \[\forall j < |w_i|, q_{i,j}, (w_{i})_{|w_i| - j} \xrightarrow\varepsilon
      q_{i,j+1},\varepsilon\]
