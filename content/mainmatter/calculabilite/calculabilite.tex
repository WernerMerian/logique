...
\begin{theorem}[Post]\label{thm.Post}
  Pour tout $n \geq 1$, on a les faits suivants~:
  \begin{itemize}
...
\begin{proof}
  ...
  telle que $g(x)$ énumère tous les $x,y$ et teste si $f(x,y) \in K^{(n)}$. Si
  elle trouve $y$ tel que $f(x,y) \in \complement K^{(n)}$, elle s'arrête et
  accepte $x$.
  ...
  correspond ici à appartenir à la fois à $\HierArithS n$ et à $\HierArithP n$.
\end{proof}
