...
d'étudier la structure de mondu monde des fonctions calculables de façon
abstraite avec simplement une énumération $\Enum$ des fonctions calculables et
en ne considérant que les fonctions $\bN \to \bN$ (ou $\bN^k \to \bN^n$).
...
arithmétique (comme nous le verrons dans le \cref{chp.arith}). Toutes
...
\begin{definition}[Ensemble c.e. canonique]
  ...
  \[W_e \defeq \{n \in \bN \mid \Enum_e(n)\convcal\}\]
\end{definition}
