...
fonctions ne donnent pas une expressivité aussi forte qu'on pourrait le
souhaiter, d'où l'introduction plus tard des fonctions récursives. Cependant,
cette première notion de calcul est centrale pour plusieurs raisons~:
\begin{itemize}
...
\cref{chp.calculabilite}, mais ces résultats donneront en corollaire
