...
\begin{proof}
  ...
  \item si $A$ est de la forme $B\land C$, alors
    \begin{align*}
      ...
      \end{align*}
  \item si $A$ est de la forme $B\to C$ A FAIRE
  \item si $A$ est de la forme $\forall x,B$ A FAIRE
  \item si $A$ est de la forme $\exists x, B$ A FAIRE
  \end{itemize}
  D'où le résultat par induction. On a le résultat dans le cas particulier d'une
  formule close.
\end{proof}

Cela étant, l'inverse n'est pas vrai en général, comme le montre l'exercice
suivante.
