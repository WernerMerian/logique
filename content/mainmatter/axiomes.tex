...
\begin{proof}
  ...
  donc $C$ définit exactement une relation fonctionnelle $f$ (à $y$ on n'associe
  qu'une seule image), et par définition de $C_0$ on sait que $f(y)\in y$.
...
\begin{proof}
  ...
  \[\pi(x,y) \defeq y = \{\pi(z)\mid z \in R^{-1}[x]\}\]
