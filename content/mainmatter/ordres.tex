...
\begin{proof}
  ...
  et par hypothèse $x\lor y \in \mathcal F$. Ainsi, par stabilité de $\mathcal F$
  par $\land$, et grâce à l'égalité, on en déduit que $\bot\in\mathcal F$, ce qui
  contredit l'hypothèse que $\mathcal F$ est un ultrafiltre (donc propre).
...
\begin{proof}
  ...
  $\ref{enum.ultra.prim1}
  \implies\ref{enum.ultra.prim2}\implies\ref{enum.ultra.prim3}$
  mais on a déjà prouvé la première implication. Il nous reste à montrer les
  deux autres.
  ...
  si $\mathcal H$ est tel que $\mathcal F\subseteq\mathcal F$ et $\mathcal H$
