...
\begin{proof}
  ...
  $\varOp \cap \varPt \neq\vide$, ce qui signifie que $\sup \varPt \in \varPt$.
  ...
  $\intOO{\mInf}{x}\cap \varPt$, ce qui est impossible. Notre famille finit donc
  à un certain $\varOc$, et $\sup_{\varOb < \varOc} x_\varOb = x$, donc en utilisant
  notre hypothèse sur $\varPt$ on en déduit que $x\in \varPt$.
\end{proof}
