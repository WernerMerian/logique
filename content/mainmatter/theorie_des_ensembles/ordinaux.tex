...
\begin{proof}
  ...
  peut bien être défini comme une fonction $\makeFunName{\varCol}{X}{\varPt}$ en
  posant $\varPt\subseteq \Ord$ son codomaine. On vérifie alors que $\varCol$
...
\begin{proof}
  ...
  fonction strictement croissante témoignant du fait que $\varOc$ est cofinal à
  $\varOb$.
  On remarque alors que $\makeFunName{f\circ g}{\varOc}{\varOa}$ est cofinale à
  $\varOa$.
