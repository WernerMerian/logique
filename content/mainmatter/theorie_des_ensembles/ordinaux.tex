...
\begin{problem}[Des opérations naturelles sur les ordinaux]
  On s'intéresse à une notion d'addition et de produit permettant aux opérations
  d'avoir des propriétés plus naturelles que les opérations ordinales qu'on a pu
  voire jusqu'ici.

  \pbPart{Addition et multiplication de Hessenberg}
  ...
  \item Donner une description de l'ensemble ordonné $(\surR_{\Ow},\leq_{\Ow})$,
    de l'ensemble ordonné $(\surR_{\Ow+1},\leq_{\Ow+1})$.
  \end{pbQuest}
  ...
  \[-(L_0,R_0) \defeq (\compr{-x}{x \in L_0},\compr{-x}{x \in R_0})\]
