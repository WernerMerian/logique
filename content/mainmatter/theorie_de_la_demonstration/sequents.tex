...
\begin{proof}
  ...
  \item cas $r\square^\ddagger$~: on suppose que
    ...
    Pour tout $w'$ tel que $w\leq w'$, on sait que $w'\Vdash\Gamma$, donc que
...
\begin{theorem}[Complétude des pré-ordres pour $S4$]
  ...
  toute structure $\mathcal K$ sur un pré-ordre telle que
  $\mathcal K\models \Gamma$, alors $\mathcal K\models\bigvee\Delta$, alors
  $\Gamma\vdLS\Delta$.
\end{theorem}
