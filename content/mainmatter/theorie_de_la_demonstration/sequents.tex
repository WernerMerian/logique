...
\begin{definition}[Calcul des séquents $\LK$ \cite{Gentzen1935}]
  ...
  l'ensemble $\ProofLK(\Sigma)$ par les règles de la \cref{fig.LK}, où les
...
\begin{definition}[Commutation quantitative]
  On donne les réécritures suivantes de suites de règles, où
  $\quantif\in\{\forall,\exists\}$~:
  \begin{center}\resizebox{\textwidth}{!}{
      $\begin{array}{ccc}
        \AxiomC{$\varphi[t/x],\Gamma,\Sigma^l\vdLK\Sigma^r,\Delta$}
        ...
        \AxiomC{$\varphi[t/x],\Gamma_1,\Sigma^l_1\vdLK\Sigma^r_1,\Delta_1$}
        \RightLabel{$l\quantif$}
        ...
        \AxiomC{$\Gamma_1,\Sigma^l_1\vdLK \Sigma^r_1,\Delta_1$}
        \AxiomC{$\varphi[t/x],\Gamma_2,\Sigma^l_2\vdLK\Sigma^r_2,\Delta_2$}
        \RightLabel{$l\quantif$}
        ...
        \AxiomC{$\varphi[t/x][u/y],\Gamma[u/y]\vdLK\Delta[u/y]$}
        \RightLabel{$l\quantif$}
  ...
  \begin{center}\resizebox{\textwidth}{!}{
      $\begin{array}{ccc}
        ...
        \AxiomC{$\Gamma,\Sigma^l\vdLK\varphi[t/x],\Sigma^r,\Delta$}
        ...
        \AxiomC{$\Gamma_1,\Sigma^l_1\vdLK\varphi[t/x],\Sigma^r_1,\Delta_1$}
        \RightLabel{$r\quantif$}
        \UnaryInfC{$\Gamma_1,
        ...
        \AxiomC{$\Gamma_1,\Sigma^l_1\vdLK \Sigma^r_1,\Delta_1$}
        \AxiomC{$\Gamma_2,\Sigma^l_2\vdLK\varphi[t/x],\Sigma^r_2,\Delta_2$}
        \RightLabel{$r\quantif$}
        \UnaryInfC{$\Gamma_2,
        ...
        \AxiomC{$\Gamma[u/y]\vdLK\varphi[u/y][t/x],\Delta[u/y]$}
        \RightLabel{$r\quantif$}
...
\begin{theorem}[Herbrand]
  ...
  la disjonction des formules $\varphi[t_1/x],\ldots,\varphi[t_n/x]$ est
  prouvable.
\end{theorem}

\begin{proof}
  Si l'une des formules est prouvable, alors il est clair que
