...
\begin{definition}[Termes de preuve pour le premier ordre]
  ...
  \refl\;\btermt\mid \transp\;(\bvarx \leftarrow t)\;u\]
  ...
  \begin{center}
    \resizebox{\textwidth}{!}{
      \begin{tabular}{cc}
        ...
        \RightLabel{Transp}
        \BinaryInfC{$\Gamma\vdash \transp\;(\bvarx\leftarrow t)\;u :
          \varphi[\btermu/\bvarx]$}
        \DisplayProof
      \end{tabular}
    }
...
\begin{multline*}
  ...
  \\(u[t/x]\in \semT{\tau''}) \implies
  (v[t/x]\in\semT{\tau''}) \implies
...
\begin{definition}[Ensemble saturé]
  ...
  \end{itemize}
  On note par $\satur_\SN$ l'ensemble des parties saturées.
\end{definition}
