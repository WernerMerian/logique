...
\begin{exercise}[Sur l'implication]
  ...
  \item En déduire que pour tous $x,y \in \varBH$, si $x \leq y$ alors
    $\opng y \leq \opng x$.
  \item Si $\varBH$ est aussi une algèbre de Boole, montrer que la réciproque
    de la question précédente est vraie aussi~: si $\opng y \leq \opng x$
    alors $x \leq y$.
...
\begin{exercise}[Algèbre de Boole engendrée]
  ...
  \noindent
  Pour tout ensemble $X$, on dit qu'une partie $Y \subseteq X$ est
  ...
  $\powerset(X)$.
  \begin{enumerate}[label=(\roman*),resume]
  \item Montrer que cette sous-algèbre de Boole est engendrée par l'ensemble
    $\compr{\{x\}}{x \in X}$.
  \end{enumerate}
\end{exercise}
...
\begin{exercise}[Atomes d'une algèbre de Boole]
  ...
  \noindent
  L'objectif de cet exercice est de montrer que toute algèbre de Boole finie
  $\varBB$ peut s'écrire comme un ensemble de parties. Pour ce faire, on va
  considérer l'ensemble $\At(\varBB)$ des atomes d'une algèbre de Boole.
  \begin{enumerate}[label=(\roman*),resume]
  ...
  \item Une algèbre de Boole infinie est-elle encore isomorphe à l'ensemble
    des parties d'un ensemble~?
    \textit{Indication~: trouver une algèbre de Boole infinie sans atome.}
  \end{enumerate}
\end{exercise}

\begin{exercise}[Quotient d'algèbres de Heyting]
  Dans le cas des algèbre de Boole, le complémentaire d'un filtre étant un
  idéal, on possède une façon naturelle de construire une algèbre de Boole
  quotient. \'Etudions le cas d'une algèbre de Heyting.

  Soit $\varBH$ une algèbre de Heyting et $\varFil$ un filtre sur $\varBH$.
  On définit la relation $\sim_{\varFil}$ par
  ...
  \item Montrer que si $\varBB$ est une algèbre de Boole et $\varFil$ est un
    filtre sur $\varBB$, alors en posant
    \[\varId \defeq \compr{\varBB \setminus F}{F \in \varFil}\]
    on a une pour tous $x,y \in \varBB$ l'équivalence
  ...
  morphisme adaptée aux algèbres de Heyting. Pour deux algèbres de Heyting
  $\varBH,\varBH'$, on dit que $f : \varBH \to \varBH'$ est un morphisme
  lorsque $f$ est un morphisme de treillis qui, de plus, commute avec
  l'implication~:
  \[\forall x,y \in \varBH, f(x \opimp y) = f(x) \opimp f(y)\]
  Dans le reste de l'exercice, on fixe $\varBH,\varBH'$ deux algèbres de Heyting
  et $f : \varBH \to \varBH'$ un morphisme entre les deux.
  \begin{enumerate}[label=(\roman*),resume]
  ...
  \item Montrer que si $\varBH_0\subseteq \varBH$ est une sous-algèbre de
    ...
    $\varBH'$, alors $f^{-1}(\varBH'_0)$ est une sous-algèbre de Heyting de
    $\varBH$.
  \item Montrer que la fonction induite par $f$
    \[\makeFun{\relev{f}}{\quot{\varBH}{\ker(f)}}{\im(f)}{\cl(x)}{f(x)}\]
    est bien définie et est un isomorphisme d'algèbres de Heyting (c'est-à-dire
    un isomorphisme de treillis).
...
\begin{problem}[Logique temporelle linéaire \cite{LTL77}]
  ...
  \item $\ValE(\modNext\varFF)=
    \comprB{\varstr\in\infWd}{\upstr\in\ValE(\varFF)}$
  \end{itemize}
  ...
  \item Montrer que l'algèbre de Lindenbaum-Tarski
    ...
    est une algèbre de Boole, avec les opérations induites par les constructeurs
    des formules.
  \item Montrer que $\modNext$ induit la fonction
    ...
    \]
    qui est un morphisme d'algèbre de Boole.
  \end{pbQuest}
  ...
  \comprB{\varstr\in\infWd}{\exists i \in \bN,
    \begin{array}{l}
