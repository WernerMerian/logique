...
\begin{remark}
  ...
  L'ensemble ordonné construit par $\quot{\Formula(\Sigma)}{\dvvd}$ est appelé
...
\begin{notation}
  Si la borne supérieure de $Y$ existe, on la notera $\bigvee Y$. Si la borne
  inférieure de $Y$ existe, on la notera $\bigwedge Y$.
\end{notation}
...
\begin{exercise}
  ...
  \[\bigvee \left(\bigcup A\right) =
  \bigvee\compr{\bigvee a}{a \in A}\]
\end{exercise}
...
\begin{proof}
  ...
  \item si $x\leq_\lor y$ et $y\leq_\lor x$, alors $x\lor y = y$ et
    ...
    donc
    \begin{align*}
      x &= y \lor x &\text{car } y \leq_{\lor} x\\
      &= x \lor y &\text{par commutativité}\\
      &= y & \text{car } x \leq_{\lor} y
    \end{align*}
  \item si $x\leq_\lor y$ et $y\leq_\lor z$, alors $x\lor y = y$ et
    $y \lor z = z$
    donc
    \begin{align*}
      x\lor z &= x \lor (y \lor z) &\text{car } y \leq_\lor z\\
      &= (x \lor y) \lor z &\text{par associativité}\\
      &= y \lor z &\text{car } x \leq_\lor y\\
      &= z &\text{car } y \leq_\lor z
    \end{align*}
  \end{itemize}
