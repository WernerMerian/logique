...
environnement $\rho$ contenant les variables libres d'une proposition $P$ donnée
ne définit $\Val_\rho(P)$ que par les valeurs des variables libres listées dans
...
\begin{exercise}[Forme normale conjonctive, disjonctive]
  ...
  \begin{itemize}
  \item on appelle littéral une proposition de la forme $x$ ou $\lnot x$, où
    $x$ est une variable~;
  ...
  \item Montrer les lois de distributivité suivantes, pour toutes propositions
    ...
    P\lor (Q \land R) \equiv (P\land Q) \land (P\lor R)\]
  \item Montrer l'équivalence suivante, pour toutes propositions $P,Q$~:
