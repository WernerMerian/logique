...
\begin{notation}
  ...
  si $f : X \to Y$ est une fonction et $A \subseteq X$, alors on note
  $f\restr{A}$ la restriction de $f$ à $A$, c'est-à-dire la fonction
  $f\restr{A} : A \to Y$ définie par $x \mapsto f(x)$.
\end{notation}
