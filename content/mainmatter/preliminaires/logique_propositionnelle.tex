...
\begin{exercise}[Systèmes de connecteurs]
  ...
  \begin{enumerate}[label=(\roman*)]
  \item Soit une fonction $\makeFunName{f}{\intB^n}{\intB}$. Montrer qu'il existe
    une formule $\varFF_f$ dont les variables libres sont parmi $x_1,\ldots,x_n$
    et telle que pour tout $n$-uplet $(b_1,\ldots,b_n)$~:
...
\begin{problem}[Le théorème de complétude]
  ...
  $\makeFunNamePartial{\env}{\Var}{\intB}$, on définit le contexte $\varCG_{\env}$
  par~:
  \begin{itemize}
