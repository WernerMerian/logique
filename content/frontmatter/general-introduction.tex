...
L'auteur étant principalement rodés à la logique mathématique et à
...
régulièrement faits au long de cet ouvrage. Lorsque cela arrivera, la position
...
Ainsi, quand nous prouvons qu'il ne peut exister de preuve, dans $\ZFC$, que
$\ZFC$ est cohérente, où $\ZFC$ est la théorie des ensembles dans laquelle
toutes les mathématiques usuelles peuvent se faire, nous en extrapolons
largement qu'il n'existe pas de preuve de la cohérence de $\ZFC$. Pourtant, les
deux expressions ne signifient pas strictement la même chose, mais il est cette
conviction forte chez nombre de logiciens que cette étude des mathématiques par
les mathématiques nous apprend des choses sur leur nature.
...
Cet ouvrage s'appuie principalement sur un semestre de cours suivi par
l'auteur, qui couvrait les quatre thèmes principaux de la logique~:
\begin{itemize}
...
C'est donc naturellement que ce cours sera structuré suivant ces quatre
...
Nous remercions nos professeurs Arnaud \name{Durand}, Thomas \name{Ibarlucia},
Thierry \name{Joly} et Alessandro \name{Vignati}, du master LMFI, ainsi que
Daniel \name{Hirschkoff}, Pascal \name{Koiran}, Natacha \name{Portier} et
Colin \name{Riba} qui ont été nos professeurs à l'\'ENS de Lyon et
dont les cours ont été de magnifiques portes d'entrée vers le monde de la
logique.

Nous remercions aussi Jean \name{Caspar} pour les nombreuses parties relues et
Abdelrahman \name{Zighem} pour les discussions enrichissantes à propos de la
topologie qui ont nourri ce livre. Un très grand merci aussi à Werner
\name{Merian} pour avoir organisé l'architecture du projet (dépôt github,
makefile, organisation des dossiers \ldots) et pour avoir encouragé l'auteur à
poursuivre ce projet.

Le contenu de cet ouvrage est avant tout un mélange des cours de ces différents
professeurs, ainsi que de divers livres lus par son auteur. Nous pouvons dès
maintenant citer ceux de René \name{Cori} et Daniel \name{Lascar}
(\cite{Cori2003,Cori2020}), qui offrent une excellente
