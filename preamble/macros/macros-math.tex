...
\newcommand{\powerfin}{\mathcal{P}_{\mathrm{fin}}} % ensemble des parties finies
...
\newcommand{\Formqf}{\Formula_{\mathrm{qf}}}
...
\newcommand{\Dedekind}{\mathfrak{D}}
\newcommand{\subfil}{\subseteq_{\mathrm{fil}}}
...
\DeclareMathOperator{\concl}{conclusion}
...
\newcommand{\godcod}[1]{\ulcorner#1\urcorner}
\DeclareMathOperator{\Regex}{Regex}
\DeclareMathOperator{\Ratio}{Ratio}
\DeclareMathOperator{\Reco}{Reco}
\DeclareMathOperator{\tr}{tr}
\DeclareMathOperator{\MultExp}{MultiplicativeExpr}
\DeclareMathOperator{\RecP}{RP}
\DeclareMathOperator{\Rec}{Rec}
\DeclareMathOperator{\RPG}{RPG}
\DeclareMathOperator{\RecG}{RecG}
\DeclareMathOperator{\sucs}{succ}
\DeclareMathOperator{\rec}{rec}
\DeclareMathOperator{\ifrm}{if}
\DeclareMathOperator{\km}{k}
\DeclareMathOperator{\TM}{TM}
\DeclareMathOperator{\Calc}{Calc}
...
\newcommand{\fillim}{\lim^{\mathcal F}}
