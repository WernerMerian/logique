...
\newcommand{\tok}{\cdot} % placeholder pour les définitions anonyme
...
\newcommand{\vdP}{\vd} % relation de prouvabilité pour LK propositionnel
\newcommand{\nvdP}{\nvdash}
...
\newcommand{\comodels}{\models^{\mathrm{co}}}

%----- LOGIQUE PROPOSITIONNELLE -----%

\newcommand{\Enviro}{\mathcal E}
