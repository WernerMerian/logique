...
\usepackage[linesnumbered, vlined, nofillcomment, figure, french, frenchkw]{algorithm2e}
...
\input{./preamble/config/config-xcolor.tex}
...
\input{./preamble/config/config-imakeidx.tex}
...
\usepackage{hyperref}
\input{./preamble/config/config-hyperref.tex}
