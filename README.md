...
- [ ] TeX live
- [ ] latexmk
(- [ ] le package python `Pygments`, voir: [https://pygments.org/](https://pygments.org/). Ce package python est demandé par le package LaTeX `minted`, pour la coloration syntaxique notemment.)
